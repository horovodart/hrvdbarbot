/* Данные для первичной заливки: 14 позиций из прототипа + 2 из чека Metro,
   опорный подсчёт 22.07.2026 и закупка Tesco 17.08.2026.
   После успешного setup() этот файл можно удалить. */
